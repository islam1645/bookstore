    ...
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {isLoading ? (
            ...
            <div className="text-red-500 text-center">Erreur : {message}</div>
        ) : filteredBooks.length === 0 ? (
            <div className="text-center py-20 text-gray-500">
                <p className="text-xl">Aucun livre trouvé.</p>
                <button onClick={() => {setSearchTerm(''); setSelectedCategory('Tout')}} className="mt-4 text-blue-600 hover:underline flex items-center gap-2 justify-center">
